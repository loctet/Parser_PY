...
def _start_0(minimize = False):
    ...
    if minimize :
        ...
        if not result: 
            ...
            print("\nMinify of the Not Formula: ", simplify(Not(ForAll([state,offer,B], Implies(True, Or(Exists([_offer], _offer  > 0)))))), " :: ", solver__start_02.check() == z3.sat)
...
def _acceptOffer_0(minimize = False):
    ...
    if minimize :
        ...
        if not result: 
            ...
            print("\nMinify of the Not Formula: ", simplify(Not(ForAll([state,offer,B], Implies(True, True)))), " :: ", solver__acceptOffer_02.check() == z3.sat)
            if solver__acceptOffer_02.check() == z3.sat :
                print("\nNot Formula Model: ",solver__acceptOffer_02.model() , "\n")
...
def _rejectOffer_0(minimize = False):
    ...
    if minimize :
        ...
        if not result: 
            ...
            print("\nMinify of the Not Formula: ", simplify(Not(ForAll([state,offer,B], Implies(True, Or(Exists([_offer], _offer  > 0)))))), " :: ", solver__rejectOffer_02.check() == z3.sat)
            if solver__rejectOffer_02.check() == z3.sat :
                print("\nNot Formula Model: ",solver__rejectOffer_02.model() , "\n")
...
def _makeOffer_0(minimize = False):
    ...
    if minimize :
        ...
        if not result: 
            ...
            print("\nMinify of the Not Formula: ", simplify(Not(ForAll([state,offer,B,_offer], Implies(And(offer   ==  _offer), Or(True,True))))), " :: ", solver__makeOffer_02.check() == z3.sat)
            if solver__makeOffer_02.check() == z3.sat :
                print("\nNot Formula Model: ",solver__makeOffer_02.model() , "\n")
